...
Repository contains 4 R scripts and 4 png, produced by R scripts. All scripts assume that's workspace contain directory "data" with txt file acquired from link above.
